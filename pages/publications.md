...
<div align="center">
  ...
  <p>
    ...
    <a href="events"><img src="https://img.shields.io/badge/Events-005A9E?style=for-the-badge&logo=googlecalendar&logoColor=white" alt="Events"></a>
  </p>
</div>

---

## <img src="https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/library.svg" width="22" height="22" style="vertical-align: middle;"> Full Publication List

### <img src="https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/landmark.svg" width="18" height="18" style="vertical-align: middle;"> Journals
...
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Category-wise Fine-Tuning: Resisting incorrect pseudo-labels in multi-label image classification with partial labels**](https://doi.org/10.1016/j.neucom.2025.130498)<br>Chak Fong Chong, Xinyi Fang, Jielong Guo, Pedro Henriques Abreu, et al. \| *Neurocomputing* | 2025 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Unveiling group-specific distributed concept drift: A fairness imperative in federated learning**](https://doi.org/10.1109/TNNLS.2025.3601834)<br>Teresa Salazar, João Gama, Helder Araújo, Pedro Henriques Abreu \| *IEEE TNNLS* | 2025 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Enhancing the robustness of solar photovoltaic fault classification based on depthwise separable group equivariant CNNs**](https://doi.org/10.1016/j.aej.2025.04.063)<br>Jielong Guo, Chak Fong Chong, Pedro Henriques Abreu, et al. \| *Alexandria Engineering Journal* | 2025 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**LogicMix: Sample mixing data augmentation for multi-label image classification with partial labels**](https://doi.org/10.1016/j.patcog.2025.112186)<br>Chak Fong Chong, Jielong Guo, Xu Yang, Wei Ke, Pedro Henriques Abreu, et al. \| *Pattern Recognition* | 2025 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Reparameterization convolutional neural networks for handling imbalanced datasets in solar panel fault classification**](https://doi.org/10.1016/j.engappai.2025.110541)<br>Jielong Guo, et al. \| *Eng. App. of AI* | 2025 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**A label propagation approach for missing data imputation**](https://doi.org/10.1109/ACCESS.2025.3559772)<br>Filipe Loyola Lopes, Arthur Dantas Mangussi, Ricardo Cardoso Pereira, Miriam Seoane Santos, Pedro Henriques Abreu, Ana Carolina Lorena \| *IEEE Access* | 2025 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Guidelines for designing visualization tools for group fairness analysis in binary classification**](https://doi.org/10.1007/s10462-025-11179-w)<br>António Cruz, Teresa Salazar, Manuel Carvalho, et al. \| *Artificial Intelligence Review* | 2025 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Enhancing mammography: a comprehensive review of computer methods for improving image quality**](https://doi.org/10.1088/2516-1091/ad776b)<br>Joana Cristo Santos, Miriam Seoane Santos, Pedro Henriques Abreu \| *Progress in Biomedical Engineering* | 2024 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Imputation of data Missing Not at Random: Artificial generation and benchmark analysis**](https://doi.org/10.1016/j.eswa.2024.123654)<br>Ricardo Cardoso Pereira, Pedro Henriques Abreu, Pedro Pereira Rodrigues, Mário AT Figueiredo \| *Expert Systems with Applications* | 2024 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Siamese autoencoder architecture for the imputation of data missing not at random**](https://doi.org/10.1016/j.jocs.2024.102269)<br>Ricardo Cardoso Pereira, Pedro Henriques Abreu, Pedro Pereira Rodrigues \| *Journal of Computational Science* | 2024 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**A global taxonomy of interpretable AI: unifying the terminology for the technical and social sciences**](https://doi.org/10.1007/s10462-022-10256-8)<br>Mara Graziani, Lidia Dutkiewicz, Davide Calvaresi, José Pereira Amorim, et al. \| *Artificial Intelligence Review* | 2023 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Evaluating the faithfulness of saliency maps in explaining deep learning models using realistic perturbations**](https://doi.org/10.1016/j.ipm.2022.103225)<br>José P Amorim, Pedro H Abreu, João Santos, Marc Cortes, Victor Vila \| *IP&M* | 2023 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**A unifying view of class overlap and imbalance: Key concepts, multi-view panorama, and open avenues for research**](https://doi.org/10.1016/j.inffus.2022.08.017)<br>Miriam Seoane Santos, Pedro Henriques Abreu, Nathalie Japkowicz, et al. \| *Information Fusion* | 2023 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**On the joint-effect of class imbalance and overlap: a critical review**](https://doi.org/10.1007/s10462-022-10150-3)<br>Miriam Seoane Santos, Pedro Henriques Abreu, Nathalie Japkowicz, et al. \| *Artificial Intelligence Review* | 2022 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**Partial multiple imputation with variational autoencoders: tackling not at randomness in healthcare data**](https://doi.org/10.1109/JBHI.2022.3172656)<br>Ricardo Cardoso Pereira, Pedro Henriques Abreu, Pedro Pereira Rodrigues \| *IEEE JBHI* | 2022 |
| <img src="https://img.shields.io/badge/Paper-Journal-blue?style=flat-square" alt="Journal"> | [**The impact of heterogeneous distance functions on missing data imputation and classification performance**](https://doi.org/10.1016/j.engappai.2022.104791)<br>Miriam Seoane Santos, Pedro Henriques Abreu, et al. \| *Eng. App. of AI* | 2022 |

<br>

### <img src="https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/mic.svg" width="18" height="18" style="vertical-align: middle;"> Conferences
...
### <img src="https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/file-text.svg" width="18" height="18" style="vertical-align: middle;"> Preprints
